                ...
                try:
                    ...
                    if file_extension.lower() == '.md':
                        ...
                        if links:
                            ...
                            graph_store.update_graph_edges(file_name, cleaned_links)
                    ...
                    for i, chunk_content in enumerate(chunks):
                        ...
                        # Pasamos la conexión existente para evitar abrir y cerrar constantemente
                        db.insert_chunk(conn, chunk_id, file, chunk_content, i)
